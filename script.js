...
function compactUserForStorage(user) {
    ...
    return {
        ...
        avatarAnimationEnabled: user?.avatarAnimationEnabled === false ? false : Boolean(user?.avatarAnimationEnabled ?? true),
        avatarGlowEnabled: user?.avatarGlowEnabled === false ? false : Boolean(user?.avatarGlowEnabled ?? true),
...
async function syncCurrentUserProfileToSupabase() {
    ...
    let payload = {
        ...
        avatar_animation_enabled: Boolean(avatarAnimationEnabled),
        avatar_glow_enabled: Boolean(avatarGlowEnabled),
        glow_animation: glowAnimation,
        nickname_gradient_enabled: Boolean(nicknameGradientEnabled),
...
function loadEditData() {
    ...
    const savedAvatarAnimationEnabled = getAvatarAnimationEnabled();
    const savedAvatarGlowEnabled = getAvatarGlowEnabled();
    const savedNicknameGradientEnabled = getNicknameGradientEnabled();
...
function saveEditData() {
    ...
    if (editAvatarAnimationEnabledInput) {
        const animationEnabled = Boolean(editAvatarAnimationEnabledInput.checked);
    ...
    if (editAvatarGlowEnabledInput) {
        const glowEnabled = Boolean(editAvatarGlowEnabledInput.checked);
    ...
    if (editNicknameGradientInput) {
        const nicknameGradientEnabled = Boolean(editNicknameGradientInput.checked);
    ...
    if (userIndex !== -1) {
        ...
        users[userIndex] = {
            ...
            nicknameGradientEnabled: localStorage.getItem(getNicknameGradientKey(currentUserEmail)) === '1',
            ...
            avatarAnimationEnabled: localStorage.getItem('avatarAnimationEnabled_' + currentUserEmail) === '0' ? false : (existingUser.avatarAnimationEnabled === false ? false : true),
            avatarGlowEnabled: localStorage.getItem('avatarGlowEnabled_' + currentUserEmail) === '0' ? false : (existingUser.avatarGlowEnabled === false ? false : true),
...
function getUserProfileDataByEmail(email) {
    ...
    return {
        ...
        nicknameGradientEnabled: nicknameGradientEnabledRaw === true || nicknameGradientEnabledRaw === '1',
        ...
        avatarAnimationEnabled: avatarAnimationEnabledRaw === false || avatarAnimationEnabledRaw === '0' ? false : true,
        avatarGlowEnabled: avatarGlowEnabledRaw === false || avatarGlowEnabledRaw === '0' ? false : true,
