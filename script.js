...
function initChatSubmenu() {
    ...
    function moveTo(btn) {
        ...
        // Keep horizontal margins close to the vertical 4px inset for a wider pill.
        const reduce = Math.min(16, Math.round(btnWidth * 0.07));
    ...
    if (!visibleMessages.length) {
        ...
        visibleMessages.forEach(message => {
            ...
            if (dateKey !== lastDateKey) {
                lastDateKey = dateKey;
                let label = ts.toLocaleDateString('ru-RU', { day: 'numeric', month: 'short', year: 'numeric' });
            ...
            html += createMessageBubbleMarkup(message, peerEmail);
        });
